  ...
  server.registerTool(
    "update_campaign_message",
    {
      ...
      inputSchema: {
        ...
        messageId: z
          .string()
          .describe("The message template ID (24-character hex string)"),
        contentHtml: z
          .string()
          .optional()
          .describe("New HTML content for the message body"),
        subjectHtml: z
          .string()
          .optional()
          .describe("New HTML content for the email subject"),
      },
    ...
    async (params, extra) => {
      ...
      if (!params.contentHtml && !params.subjectHtml) {
        return handleToolError(
          new Error(
            "At least one of contentHtml or subjectHtml must be provided",
          ),
        );
      }
      try {
        ...
        await trackMcpEvent(apiKey, "mcp_message_updated", {
          toolName: "update_campaign_message",
        });
